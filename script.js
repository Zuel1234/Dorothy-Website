...
buy.addEventListener("click", (e) => {
 ...
 if(cartData.length === 0){
  ...
  window.open(`https://wa.me/+233548879613?text= DOROTHY COUTURE %0A Please kindly send us screenshot of the ${cartData.length} ${itemCount} in your cart page to process delivery`,"_blank")
 }
